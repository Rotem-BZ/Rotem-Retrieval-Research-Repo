...
from retrieval_research.input_mapping import (
...
from retrieval_research.io import read_json, write_json, write_jsonl
...
def test_generated_recipe_materializes_missing_mapping(tmp_path: Path) -> None:
    cfg = _cfg(
        tmp_path,
        {
            "type": "generated",
