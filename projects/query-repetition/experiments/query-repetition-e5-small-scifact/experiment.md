...
| --- | --- | --- | --- |
| Inference pipeline | Core [`retrieve/dense_in_memory`](../../../../packages/retrieval-core/src/retrieval_core/configs/pipeline/inference/retrieve/dense_in_memory.yaml) | Project [`query_repetition/dense_query_repetition`](../../configs/pipeline/inference/query_repetition/dense_query_repetition.yaml) | No; this is the treatment boundary |
| Query transformation | Raw query goes directly to E5 preprocessing | [`QueryRepeater`](../../src/query_repetition/components.py) emits `"<query> <query>"` before E5 preprocessing | No; primary treatment |
...
Run these commands from `projects/query-repetition`. Before launching, replace the
...
uv run stage indexing dataset=beir_scifact runtime=cpu pipeline/indexing@pipeline=dense/documents_in_memory selections/embedding_model=e5/small_v2 selections.index_id=$indexId runtime.concurrency_limit=4 stage.run_id=$indexingRun
...
- `artifacts/indexes/$indexId/index.json`
